...
export const AppointmentForm = (props: AppointmentFormProps) => {
  const { userId, patientId, type = "create", appointment, setOpen } = props;
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex-1 space-y-6">
        ...
        {type === "cancel" && (
          <CustomFormField
            fieldType={FormFieldType.TEXT_AREA}
            control={form.control}
            formName="cancellationReason"
            formLabel="Reason for cancellation"
            inputPlaceholder="Urgent meeting came up"
          />
        )}
